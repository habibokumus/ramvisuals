...
export default function Testimonial() {
   return (
      <section className="grid grid-cols-1 items-center justify-between gap-10 px-6 py-[150px] md:px-[80px] lg:grid-cols-2 lg:px-[150px]">
         ...
         >
            {say.map((item) => {
               return (
                  <div
                     key={kgid()}
                     className="flex w-full flex-col rounded-[37px] bg-[#F7F9FA] px-4 py-4 lg:px-10 lg:py-14"
                  >
                     <SaySvg />
